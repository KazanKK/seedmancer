...
// DatasetSQLFileName is the conventional name of the agent-written SQL
// sidecar inside a scenario revision directory.
const DatasetSQLFileName = "dataset.sql"
...
//
// Priority:
//  1. SEEDMANCER_API_URL — internal test override; not documented for users.
//  2. https://api.seedmancer.dev
//
// The api_url YAML key is not supported.
